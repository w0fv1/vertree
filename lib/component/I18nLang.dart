...
class AppLocale {
  ...
  static const Map<LocaleKey, String> _EN = {
    ...
    LocaleKey.fileleaf_shareLandingLink: "Short share link",
    ...
    LocaleKey.fileleaf_shareOpenLanding: "Open share page",
    LocaleKey.fileleaf_shareOpenFailed: "Unable to open the share page",
  ...
  static const Map<LocaleKey, String> _ZH_CN = {
    ...
    LocaleKey.fileleaf_shareLandingLink: "短分享链接",
    LocaleKey.fileleaf_shareCandidates: "局域网直连候选地址",
    LocaleKey.fileleaf_shareBrowserHint: "如果浏览器无法在分享页里自动选路，可以直接使用下面任一局域网下载链接。",
    LocaleKey.fileleaf_shareCopiedLink: "链接已复制",
    LocaleKey.fileleaf_shareCopyLink: "复制链接",
    LocaleKey.fileleaf_shareOpenLanding: "打开分享页",
    LocaleKey.fileleaf_shareOpenFailed: "无法打开分享页",
  ...
  static const Map<LocaleKey, String> _JA = {
    ...
    LocaleKey.fileleaf_shareLandingLink: "短い共有リンク",
    ...
    LocaleKey.fileleaf_shareOpenLanding: "共有ページを開く",
    LocaleKey.fileleaf_shareOpenFailed: "共有ページを開けませんでした",

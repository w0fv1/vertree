...
enum LocaleKey {
  ...
  fileleaf_shareLandingLink,
  fileleaf_shareCandidates,
  fileleaf_shareBrowserHint,
  fileleaf_shareCopiedLink,
  fileleaf_shareCopyLink,
  fileleaf_shareOpenLanding,
  fileleaf_shareOpenFailed,
  fileleaf_monitTitle,
...
class AppLocale {
  ...
  static const Map<LocaleKey, String> _EN = {
    ...
    LocaleKey.setting_httpApiRunning: "Running",
    LocaleKey.setting_httpApiStopped: "Stopped",
    LocaleKey.setting_httpApiDocs: "Open API docs",
    LocaleKey.setting_launchToTray: "Hide to tray on startup",
    ...
    LocaleKey.setting_donate: "Donate & Support",
    ...
    LocaleKey.fileleaf_shareExpiresAt: "Expires at",
    LocaleKey.fileleaf_shareLandingLink: "Landing link",
    LocaleKey.fileleaf_shareCandidates: "Direct LAN download candidates",
    LocaleKey.fileleaf_shareBrowserHint:
        "If the landing page cannot auto-detect the route in your browser, use one of the direct LAN links below.",
    LocaleKey.fileleaf_shareCopiedLink: "Link copied",
    LocaleKey.fileleaf_shareCopyLink: "Copy link",
    LocaleKey.fileleaf_shareOpenLanding: "Open landing page",
    LocaleKey.fileleaf_shareOpenFailed: "Unable to open the landing page",
  ...
  static const Map<LocaleKey, String> _ZH_CN = {
    ...
    LocaleKey.setting_httpApiRunning: "运行中",
    LocaleKey.setting_httpApiStopped: "未启动",

    LocaleKey.setting_httpApiDocs: "打开 API 文档",
    LocaleKey.setting_launchToTray: "启动后隐藏到托盘",
    ...
    LocaleKey.setting_donate: "捐助和支持",
    ...
    LocaleKey.fileleaf_shareExpiresAt: "失效时间",
    LocaleKey.fileleaf_shareLandingLink: "桥接页链接",
    LocaleKey.fileleaf_shareCandidates: "局域网直连候选地址",
    LocaleKey.fileleaf_shareBrowserHint: "如果浏览器无法在桥接页里自动选路，可以直接使用下面任一局域网下载链接。",
    LocaleKey.fileleaf_shareCopiedLink: "链接已复制",
    LocaleKey.fileleaf_shareCopyLink: "复制链接",
    LocaleKey.fileleaf_shareOpenLanding: "打开桥接页",
    LocaleKey.fileleaf_shareOpenFailed: "无法打开桥接页",
  ...
  static const Map<LocaleKey, String> _JA = {
    ...
    LocaleKey.setting_contextMenuGroup: "右クリックメニュー項目",
    ...
    LocaleKey.setting_donate: "寄付とサポート",
    ...
    LocaleKey.fileleaf_shareExpiresAt: "有効期限",
    LocaleKey.fileleaf_shareLandingLink: "ランディングリンク",
    LocaleKey.fileleaf_shareCandidates: "LAN 直リンク候補",
    LocaleKey.fileleaf_shareBrowserHint:
        "ブラウザがランディングページで自動判定できない場合は、以下の LAN リンクを直接使ってください。",
    LocaleKey.fileleaf_shareCopiedLink: "リンクをコピーしました",
    LocaleKey.fileleaf_shareCopyLink: "リンクをコピー",
    LocaleKey.fileleaf_shareOpenLanding: "ランディングページを開く",
    LocaleKey.fileleaf_shareOpenFailed: "ランディングページを開けませんでした",
